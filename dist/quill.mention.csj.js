...
function () {
  function Mention(quill, options) {
    ...
    document.getElementById("uni-quill-mention").appendChild(this.mentionContainer);
  ...
  _createClass(Mention, [{
    ...
    value: function setMentionContainerPosition() {
      ...
      var topPos = containerPos.y;
      var leftPos = containerPos.x + mentionCharPos.left;

      if (this.containerRightIsNotVisible(leftPos, containerPos)) {
        var rightPos = leftPos + this.mentionContainer.offsetWidth + containerPos.left;
        var browserWidth = window.pageXOffset + document.documentElement.clientWidth;
        var diff = rightPos - browserWidth;
        leftPos = leftPos - diff;
      } // Attempt to align the mention container with the bottom of the quill editor


      if (this.options.fixMentionsToQuill) {
        topPos += containerPos.height; //   const containerWidth =
      ...
      if (this.containerBottomIsNotVisible(topPos, containerPos)) {
        topPos = topPos - containerHeight - mentionCharPos.bottom - mentionCharPos.top;
      }
